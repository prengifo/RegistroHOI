...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Persona.examen1'
        db.add_column(u'registry_persona', 'examen1',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Persona.examen2'
        db.add_column(u'registry_persona', 'examen2',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Persona.examen3'
        db.add_column(u'registry_persona', 'examen3',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Persona.examen4'
        db.add_column(u'registry_persona', 'examen4',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Persona.examen5'
        db.add_column(u'registry_persona', 'examen5',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Persona.examen6'
        db.add_column(u'registry_persona', 'examen6',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Persona.examen1'
        db.delete_column(u'registry_persona', 'examen1')

        # Deleting field 'Persona.examen2'
        db.delete_column(u'registry_persona', 'examen2')

        # Deleting field 'Persona.examen3'
        db.delete_column(u'registry_persona', 'examen3')

        # Deleting field 'Persona.examen4'
        db.delete_column(u'registry_persona', 'examen4')

        # Deleting field 'Persona.examen5'
        db.delete_column(u'registry_persona', 'examen5')

        # Deleting field 'Persona.examen6'
        db.delete_column(u'registry_persona', 'examen6')
