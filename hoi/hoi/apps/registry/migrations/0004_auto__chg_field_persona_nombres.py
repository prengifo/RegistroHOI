...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Persona.nombres'
        db.alter_column(u'registry_persona', 'nombres', self.gf('django.db.models.fields.CharField')(max_length=128))

    def backwards(self, orm):

        # Changing field 'Persona.nombres'
        db.alter_column(u'registry_persona', 'nombres', self.gf('django.db.models.fields.DateField')(max_length=128))
