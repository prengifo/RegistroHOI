...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Persona.telefonos'
        db.add_column(u'registry_persona', 'telefonos',
                      self.gf('django.db.models.fields.CharField')(default='04149729958', max_length=64),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Persona.telefonos'
        db.delete_column(u'registry_persona', 'telefonos')
