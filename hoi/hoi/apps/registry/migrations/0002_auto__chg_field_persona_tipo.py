...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Persona.tipo'
        db.alter_column(u'registry_persona', 'tipo', self.gf('django.db.models.fields.IntegerField')())

    def backwards(self, orm):

        # Changing field 'Persona.tipo'
        db.alter_column(u'registry_persona', 'tipo', self.gf('django.db.models.fields.PositiveSmallIntegerField')())
