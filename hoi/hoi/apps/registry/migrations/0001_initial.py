...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'registry_persona', (
            ...
            ('tipo_identificacion', self.gf('django.db.models.fields.IntegerField')()),
            ...
            ('hospital_procedencia_ciudad', self.gf('django.db.models.fields.TextField')()),
            ('hospital_procedencia_pais', self.gf('django.db.models.fields.TextField')()),
            ...
            ('promedio_areas', self.gf('django.db.models.fields.CharField')(max_length=8, null=True, blank=True)),
            ('nota_apreciativa1', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True, blank=True)),
            ('examen_admision', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True, blank=True)),
            ...
            ('examen_final', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True, blank=True)),
            ...
            ('amonestaciones', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True, blank=True)),
            ('asistencia', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True, blank=True)),
            ('sintesis_curricular', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('observaciones', self.gf('django.db.models.fields.CharField')(max_length=140, null=True, blank=True)),
        ))
