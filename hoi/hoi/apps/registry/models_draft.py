...
class Persona(models.Model):
    ...
    promedio_areas = models.PositiveIntegerField('promedio areas', blank=True, null=True)
    ...
    promedio_examenes = models.PositiveIntegerField('promedio examenes', blank=True, null=True)
    nota_apreciativa2 = models.PositiveSmallIntegerField('nota apreciativa monografia', blank=True, null=True)
    inasistencias = models.PositiveSmallIntegerField('inasistencias', blank=True, null=True)
